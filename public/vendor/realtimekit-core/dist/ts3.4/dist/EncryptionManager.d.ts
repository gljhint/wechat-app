...
declare class ClientMap<T extends (EventMap & WildCardEvent<T>), U extends {
    ...
    on<E extends StringKeyOf<ModifyPrependObject<T, U> & V>>(event: E, callback: (ModifyPrependObject<T, U> & V)[E]): TypedEventEmitter<{
        [K in keyof T]: (obj: U, ...args: Parameters<T[K]>) => ReturnType<T[K]>;
    } & {
        "*": (event: String, ...args: any[]) => void;
    } & V>;
    addListener<E extends StringKeyOf<ModifyPrependObject<T, U> & V>>(event: E, callback: (ModifyPrependObject<T, U> & V)[E]): TypedEventEmitter<{
        [K in keyof T]: (obj: U, ...args: Parameters<T[K]>) => ReturnType<T[K]>;
    } & {
        "*": (event: String, ...args: any[]) => void;
    } & V>;
    off<E extends StringKeyOf<ModifyPrependObject<T, U> & V>>(event: E, callback: (ModifyPrependObject<T, U> & V)[E]): TypedEventEmitter<{
        [K in keyof T]: (obj: U, ...args: Parameters<T[K]>) => ReturnType<T[K]>;
    } & {
        "*": (event: String, ...args: any[]) => void;
    } & V>;
    once<E extends StringKeyOf<ModifyPrependObject<T, U> & V>>(event: E, callback: (ModifyPrependObject<T, U> & V)[E]): TypedEventEmitter<{
        [K in keyof T]: (obj: U, ...args: Parameters<T[K]>) => ReturnType<T[K]>;
    } & {
        "*": (event: String, ...args: any[]) => void;
    } & V>;
    prependListener<E extends StringKeyOf<ModifyPrependObject<T, U> & V>>(event: E, callback: (ModifyPrependObject<T, U> & V)[E]): TypedEventEmitter<{
        [K in keyof T]: (obj: U, ...args: Parameters<T[K]>) => ReturnType<T[K]>;
    } & {
        "*": (event: String, ...args: any[]) => void;
    } & V>;
    prependOnceListener<E extends StringKeyOf<ModifyPrependObject<T, U> & V>>(event: E, callback: (ModifyPrependObject<T, U> & V)[E]): TypedEventEmitter<{
        [K in keyof T]: (obj: U, ...args: Parameters<T[K]>) => ReturnType<T[K]>;
    } & {
        "*": (event: String, ...args: any[]) => void;
    } & V>;
    removeListener<E extends StringKeyOf<ModifyPrependObject<T, U> & V>>(event: E, callback: (ModifyPrependObject<T, U> & V)[E]): TypedEventEmitter<{
        [K in keyof T]: (obj: U, ...args: Parameters<T[K]>) => ReturnType<T[K]>;
    } & {
        "*": (event: String, ...args: any[]) => void;
    } & V>;
    removeAllListeners<E extends StringKeyOf<ModifyPrependObject<T, U> & V>>(event?: E): TypedEventEmitter<{
        [K in keyof T]: (obj: U, ...args: Parameters<T[K]>) => ReturnType<T[K]>;
    } & {
        "*": (event: String, ...args: any[]) => void;
    } & V>;
    ...
    setMaxListeners(n: number): TypedEventEmitter<{
        [K in keyof T]: (obj: U, ...args: Parameters<T[K]>) => ReturnType<T[K]>;
    } & {
        "*": (event: String, ...args: any[]) => void;
    } & V>;
...
declare class SharedKeyProvider extends BaseKeyProvider {
    ...
    constructor(options?: Partial<Pick<KeyProviderOptions, Exclude<keyof KeyProviderOptions, 'sharedKey'>>>);
