...
const RtkSpotlightIndicator = class {
    constructor(hostRef) {
    ...
    render() {
        if (!this.canSpotlight)
            return;
        return (index$1.h(index$1.Host, null, index$1.h("rtk-tooltip", { size: 'md', label: this.t('remote_access.indicator') }, index$1.h("div", { id: "sync-button", class: {
                tab: true,
                active: this.isSpotlighted,
            }, onClick: () => this.updateSpotlightState(!this.isSpotlighted) }, index$1.h("span", { class: "name" }, "Sync"), index$1.h("rtk-icon", { id: "icon", icon: this.isSpotlighted ? this.iconPack.checkmark : this.iconPack.warning, tabIndex: -1, "aria-hidden": true })))));
    }
...
RtkSpotlightIndicator.style = RtkSpotlightIndicatorStyle0;

exports.rtk_spotlight_indicator = RtkSpotlightIndicator;
