...
const RtkChannelSelectorUi = class {
    constructor(hostRef) {
        ...
        this.channelChanged = index$1.createEvent(this, "channelChanged", 7);
        /** Icon pack */
        ...
        this.renderChannelDisplayPic = (channel) => {
            ...
            if (channel.isDirectMessage || hasDisplayPic) {
                return (index$1.h("div", { class: "channel-display" }, index$1.h("rtk-avatar", { participant: {
                        name: channel.displayName,
                        picture: channel.displayPictureUrl,
                    } })));
            }
            else {
                return (index$1.h("div", { class: "channel-display" }, index$1.h("rtk-icon", { icon: this.iconPack.people, slot: "start" })));
            }
        };
        this.renderRecentMessage = (channel) => {
            if (!channel.latestMessage)
                return index$1.h("p", { class: "latest-msg new" }, this.t('chat.start_conversation'));
            let senderFragment = channel.isDirectMessage ? '' : `${channel.latestMessage.displayName}: `;
            if (channel.latestMessage.type === 'text') {
                return (index$1.h("p", { class: "latest-msg" }, senderFragment, index$1.h(TextMessage.TextMessageView, { message: channel.latestMessage.message })));
            }
            // non text
            let messageFragment = '';
            ...
            return index$1.h("p", { class: "latest-msg" }, `${senderFragment}${messageFragment}`);
        };
    }
    connectedCallback() {
...
exports.rtk_channel_selector_ui = RtkChannelSelectorUi;
