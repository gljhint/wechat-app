...
function SyncWithStore() {
    return function (proto, propName) {
        ...
        proto.connectedCallback = function () {
            ...
            host[`_rtkStoreToCleanup-${propName}`] = uiStore.uiStore;
            /**
             * NOTE(ravindra-dyte):
            ...
            if (!value) {
                ...
                uiStore.appendElement(propName, host, uiStore.uiStore);
            }
            ...
            const storeResponseListener = (event) => {
                ...
                if (event.detail.requestId === requestId) {
                    ...
                    uiStore.appendElement(propName, host, event.detail.store);
                    ...
                    uiStore.removeElement(propName, host, uiStore.uiStore);
                }
            };
        ...
        proto.disconnectedCallback = function () {
            const host = index.getElement(this);
            uiStore.removeElement(propName, host, host[`_rtkStoreToCleanup-${propName}`]);
