...
const RtkStageToggle = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { title: this.state.label }, index$1.h("rtk-tooltip", { placement: "top", kind: "block", label: this.state.label, delay: 600, part: "tooltip" }, index$1.h("rtk-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, variant: this.variant, label: this.state.label, icon: this.state.icon, onClick: this.stageCallback, disabled: this.state.disabled, showWarning: false }))));
    }
...
exports.rtk_stage_toggle = RtkStageToggle;
