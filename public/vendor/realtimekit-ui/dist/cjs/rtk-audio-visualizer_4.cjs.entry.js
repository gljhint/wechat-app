...
const RtkAudioVisualizer = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, null, index$1.h("div", { class: {
            ...
            } }, index$1.h("canvas", { width: "24", height: "24", class: {
                bars: true,
                visible: this.audioEnabled,
            }, ref: (el) => (this.visualizer = el), part: "canvas" }), !this.isScreenShare && !this.audioEnabled && (index$1.h("rtk-icon", { icon: this.iconPack.mic_off, part: "mic-off-icon" })))));
    }
...
const RtkMicrophoneSelector = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, null, this.canProduceAudio && (index$1.h("div", { part: "microphone-selection", class: 'group container ' + this.variant }, index$1.h("label", { slot: "label" }, this.variant !== 'inline' && this.t('settings.microphone_input'), index$1.h("rtk-icon", { icon: this.iconPack.mic_on, size: "sm" })), index$1.h("div", { class: "row" }, index$1.h("select", { class: "rtk-select", onChange: (e) => this.setDevice(e.target.value) }, this.audioinputDevices.map(({ deviceId, label }) => {
            var _a;
...
const RtkSpeakerSelector = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, null, index$1.h("audio", { preload: "auto", src: "https://assets.dyte.io/ui-kit/speaker-test.mp3", ref: (el) => (this.testAudioEl = el) }), index$1.h("div", { class: 'group ' + this.variant, part: "speaker-selection" }, this.speakerDevices.length > 0 && !uiStore.disableSettingSinkId(this.meeting) && (index$1.h("div", { class: "container" }, index$1.h("label", null, this.variant !== 'inline' && this.t('settings.speaker_output'), index$1.h("rtk-icon", { icon: this.iconPack.speaker, size: "sm" })), index$1.h("div", { class: "row" }, index$1.h("select", { class: "rtk-select", onChange: (e) => this.setDevice(e.target.value) }, this.speakerDevices.map(({ deviceId, label }) => {
            var _a;
        ...
        }))))), this.variant === 'full' && (index$1.h("rtk-button", { variant: "secondary", onClick: () => this.testAudio() }, index$1.h("rtk-icon", { icon: this.iconPack.speaker, slot: "start" }), this.t('test'))))));
    }
    static get watchers() { return {
        "meeting": ["meetingChanged"]
    }; }
...
const RtkSwitch = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.onChange = index$1.createEvent(this, "rtkChange", 4);
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '74affe48ce91e7be340e9d37507859fdd473bcb1', role: "switch", tabIndex: this.disabled && 0, "aria-readonly": this.readonly, "aria-checked": this.checked, "aria-disabled": this.disabled, class: { checked: this.checked }, onClick: this.onClick, onKeyPress: this.onKeyPress }, index$1.h("div", { key: '24ae27603c839d40d6452c5ee669342acb60f73d', class: "switch", part: "switch" })));
    }
    static get watchers() { return {
...
exports.rtk_audio_visualizer = RtkAudioVisualizer;
exports.rtk_microphone_selector = RtkMicrophoneSelector;
exports.rtk_speaker_selector = RtkSpeakerSelector;
exports.rtk_switch = RtkSwitch;
