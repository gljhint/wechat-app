...
const RtkGridPagination = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, null, index$1.h("rtk-button", { class: "prev", variant: "secondary", kind: "icon", disabled: this.pageCount === 0, onClick: this.prevPage, "aria-label": this.t('page.prev') }, index$1.h("rtk-icon", { icon: this.iconPack.chevron_left })), this.variant !== 'grid' && (index$1.h("div", { class: "center" }, index$1.h("span", { class: "page" }, this.pageCount === 0 ? (index$1.h("rtk-tooltip", { label: this.t('layout.auto') }, index$1.h("rtk-button", { kind: "icon", class: "auto" }, index$1.h("rtk-icon", { icon: this.iconPack.wand })))) : (this.page)), this.pageCount !== 0 && [
            index$1.h("span", { class: "slash" }, "/"),
            index$1.h("span", { class: "pages" }, this.pageCount),
        ])), this.variant === 'grid' && this.pageCount > 0 && (index$1.h("div", { class: "dots" }, [...Array(this.pageCount)].map((_, index) => (index$1.h("div", { key: `dot-${index}`, class: { dot: true, active: index + 1 === this.page } }))))), index$1.h("rtk-button", { class: "next", variant: "secondary", kind: "icon", disabled: this.page !== 0 && this.page === this.pageCount, onClick: this.nextPage, "aria-label": this.t('page.next') }, index$1.h("rtk-icon", { icon: this.iconPack.chevron_right, tabIndex: -1, "aria-hidden": true }))));
    }
...
exports.rtk_grid_pagination = RtkGridPagination;
