...
const RtkGrid = class {
    ...
    render() {
        ...
        if (this.showLiveStreamPlayer) {
            return (index$1.h(index$1.Host, null, index$1.h("rtk-livestream-player", { meeting: this.meeting, size: this.size }), index$1.h("rtk-livestream-indicator", { meeting: this.meeting, size: "sm", t: this.t }), index$1.h("rtk-viewer-count", { meeting: this.meeting, variant: "embedded", t: this.t })));
        }
        if (this.emptyStage) {
        ...
        return (index$1.h(index$1.Host, null, index$1.h(index$2.Render, { element: "rtk-grid", defaults: defaults, childProps: {
...
RtkGrid.style = RtkGridStyle0;

exports.rtk_grid = RtkGrid;
