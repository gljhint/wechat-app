...
const RtkNetworkIndicator = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, null, index$1.h("rtk-icon", { icon: this.iconPack[`signal_${signal_strength}`], class: signal_status }), index$1.h("rtk-icon", { icon: this.iconPack.signal_5, class: "bg-signal" })));
    }
...
exports.rtk_network_indicator = RtkNetworkIndicator;
