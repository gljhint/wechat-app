...
const RtkPollsToggle = class {
    constructor(hostRef) {
        ...
        this.updateCanView = () => {
            this.canViewPolls = sidebar.canViewPolls(this.meeting);
        };
    }
    connectedCallback() {
    ...
    meetingChanged(meeting) {
        ...
        if (meeting && meeting.polls) {
            ...
            this.canViewPolls = sidebar.canViewPolls(meeting);
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { title: text }, this.unreadPollsCount !== 0 && !this.pollsActive && (index$1.h("div", { class: "unread-count", part: "unread-count" }, index$1.h("span", null, this.unreadPollsCount <= 100 ? this.unreadPollsCount : '99+'))), index$1.h("rtk-controlbar-button", { ref: (el) => (this.buttonEl = el), part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: { active: this.pollsActive }, onClick: () => this.togglePollsTab(), icon: this.iconPack.poll, label: text, variant: this.variant })));
    }
...
RtkPollsToggle.style = RtkPollsToggleStyle0;

exports.rtk_polls_toggle = RtkPollsToggle;
