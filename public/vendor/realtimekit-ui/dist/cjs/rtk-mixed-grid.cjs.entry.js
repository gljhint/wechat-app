...
const RtkMixedGrid = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, null, index$1.h("main", { id: "main-view", part: "main-view" }, ((_a = this.getTabs()) === null || _a === void 0 ? void 0 : _a.length) > 1 && (index$1.h("rtk-tab-bar", Object.assign({ activeTab: this.activeTab, tabs: this.getTabs(), onTabChange: (e) => this.setActiveTab(e.detail) }, defaults))), index$1.h("div", { id: "tabs", key: "tabs" }, this.screenShareParticipants.map((participant) => {
            var _a, _b;
            return (index$1.h(index$2.Render, { element: "rtk-screenshare-view", defaults: defaults, props: {
                    participant,
                    key: participant.id,
                    style: {
            ...
            var _a, _b;
            return (index$1.h("rtk-plugin-main", Object.assign({}, defaults, { plugin: plugin, key: plugin.id, style: {
        ...
        }))), index$1.h(index$2.Render, { element: "rtk-mixed-grid", defaults: defaults, childProps: {
...
exports.rtk_mixed_grid = RtkMixedGrid;
