...
const RtkCameraToggle = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { title: label }, index$1.h("rtk-tooltip", { kind: "block", label: tooltipLabel, part: "tooltip" }, index$1.h("rtk-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: classList, variant: this.variant, label: label, icon: icon, onClick: this.toggleCamera, showWarning: showWarning, disabled: disable }))));
    }
...
RtkCameraToggle.style = RtkCameraToggleStyle0;

exports.rtk_camera_toggle = RtkCameraToggle;
