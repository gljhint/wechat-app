...
const RtkEndedScreen = class {
    constructor(hostRef) {
        ...
        /** Icon */
        this.icon = uiStore.defaultIconPack;
        /** Language */
    ...
    renderBreakoutRoomScreen() {
        return (index$1.h(index$1.Host, null, index$1.h("div", { class: "ctr", part: "container" }, index$1.h("rtk-icon", { icon: this.iconPack.breakout_rooms }), index$1.h("p", { part: "message", class: "breakout" }, this.t(this.message)))));
    }
    render() {
        if (!this.meeting)
            return null;
        ...
        return (index$1.h(index$1.Host, null, index$1.h("div", { class: "ctr", part: "container" }, index$1.h("rtk-logo", { meeting: this.meeting, config: this.config, part: "logo", t: this.t }), index$1.h("p", { part: "message" }, this.t(this.message)), (states === null || states === void 0 ? void 0 : states.roomLeftState) === 'disconnected' && (index$1.h("span", { part: "description" }, this.t('ended.network'))))));
    }
...
exports.rtk_ended_screen = RtkEndedScreen;
