...
class RtkUiBuilder {
    constructor(config) {
        this.config = config || uiStore.createDefaultConfig();
    }
    /**
...
function registerAddons(addons, meeting, config) {
    if (!config) {
        const generated = notification.generateConfig(meeting.self.config, meeting);
...
exports.BreakoutRoomsManager = uiStore.BreakoutRoomsManager;
exports.createDefaultConfig = uiStore.createDefaultConfig;
exports.createPeerStore = uiStore.createPeerStore;
exports.defaultConfig = uiStore.defaultConfig;
exports.defaultIconPack = uiStore.defaultIconPack;
exports.defaultLanguage = uiStore.defaultLanguage;
exports.getInitialStates = uiStore.getInitialStates;
exports.uiState = uiStore.uiState;
exports.uiStore = uiStore.uiStore;
exports.useLanguage = uiStore.useLanguage;
exports.provideRtkDesignSystem = merge.provideRtkDesignSystem;
exports.RtkNotificationsAudio = notification.RTKNotificationsAudio;
exports.extendConfig = notification.extendConfig;
exports.generateConfig = notification.generateConfig;
...
exports.RtkUiBuilder = RtkUiBuilder;
