...
const RtkAudioTile = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, null, index$1.h("div", { class: { 'avatar-ctr': true, speaking: this.audioEnabled, [shadowClass]: true } }, index$1.h("rtk-avatar", { participant: this.participant, size: this.size }, !this.audioEnabled && (index$1.h("div", { class: "mic-icon" }, index$1.h("rtk-icon", { icon: uiStore.defaultIconPack.mic_off }))))), index$1.h("rtk-name-tag", Object.assign({ variant: "text", participant: this.participant }, defaults)), index$1.h("slot", null)));
    }
...
RtkAudioTile.style = RtkAudioTileStyle0;

exports.rtk_audio_tile = RtkAudioTile;
