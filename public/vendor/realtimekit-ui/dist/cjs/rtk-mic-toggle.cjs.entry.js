...
const RtkMicToggle = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { title: label }, index$1.h("rtk-tooltip", { kind: "block", label: tooltipLabel, part: "tooltip" }, index$1.h("rtk-controlbar-button", { part: "controlbar-button", icon: icon, label: label, size: this.size, iconPack: this.iconPack, variant: this.variant, class: classList, onClick: this.toggleMic, showWarning: showWarning, disabled: disable }))));
    }
...
exports.rtk_mic_toggle = RtkMicToggle;
