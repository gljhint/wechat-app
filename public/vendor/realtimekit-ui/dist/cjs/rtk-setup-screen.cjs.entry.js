...
const RtkSetupScreen = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, null, index$1.h("div", { class: "container" }, index$1.h("div", { class: 'container-tile' }, index$1.h(index$2.Render, { element: "rtk-participant-tile", defaults: defaults, props: { participant: (_e = this.meeting) === null || _e === void 0 ? void 0 : _e.self, size: 'md', isPreview: true }, childProps: { participant: (_f = this.meeting) === null || _f === void 0 ? void 0 : _f.self, size: 'md' }, deepProps: true }), index$1.h("div", { class: 'media-selectors' }, index$1.h("rtk-microphone-selector", Object.assign({}, defaults, { variant: "inline" })), index$1.h("rtk-camera-selector", Object.assign({}, defaults, { variant: "inline" })), index$1.h("rtk-speaker-selector", Object.assign({}, defaults, { variant: "inline" })))), index$1.h("div", { class: "metadata" }, meetingTitle && meetingTitle !== '' && index$1.h("div", { class: "meeting-title" }, meetingTitle), this.canEditName ? (index$1.h(index$1.Fragment, null, index$1.h("div", { class: "join-as" }, this.t('setup_screen.join_in_as')), index$1.h("input", { placeholder: this.t('setup_screen.your_name'), value: this.displayName, spellcheck: false, autoFocus: true, ref: (el) => {
                this.inputEl = el;
            }, onInput: (e) => {
            ...
            } }))) : (index$1.h("div", { class: "uneditable-name" }, index$1.h("span", { class: "text" }, this.t('setup_screen.join_in_as'), " "), ' ', index$1.h("div", { class: "name" }, string.shorten(this.displayName, 20)))), index$1.h("rtk-button", { size: "lg", kind: "wide", onClick: this.join, disabled: disabled }, this.isJoining ? index$1.h("rtk-spinner", { iconPack: this.iconPack }) : this.t('join')), this.connectionState !== 'connected' && (index$1.h("div", { class: "no-network-badge" }, index$1.h("rtk-icon", { size: "md", variant: "danger", icon: this.iconPack.disconnected }), this.connectionState === 'failed'
