 ...
 */
const extendConfig = (config, baseConfig = uiStore.createDefaultConfig()) => {
    let newConfig = Object.assign({}, baseConfig);
    merge.deepMerge(newConfig, config);
    return newConfig;
};
/**
...
const generateConfig = (oldConfig, meeting, toExtend = {}, options = { grid_pagination: true, settings_toggle: true }) => {
    ...
    if (merge.isValidHexColor((_k = (_j = oldConfig === null || oldConfig === void 0 ? void 0 : oldConfig.designTokens) === null || _j === void 0 ? void 0 : _j.colors) === null || _k === void 0 ? void 0 : _k.textOnBrand)) {
    ...
    if (merge.isValidHexColor((_p = (_o = oldConfig === null || oldConfig === void 0 ? void 0 : oldConfig.designTokens) === null || _o === void 0 ? void 0 : _o.colors) === null || _p === void 0 ? void 0 : _p.videoBg)) {
...
exports.RTKNotificationsAudio = RTKNotificationsAudio;
