...
const RtkParticipantsToggle = class {
    constructor(hostRef) {
        ...
        this.updateCanView = () => {
            this.canViewParticipants = sidebar.canViewParticipants(this.meeting);
        };
    }
    connectedCallback() {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { title: text }, this.badgeCount !== 0 && !this.participantsActive && (index$1.h("div", { class: "waiting-participants-count", part: "waiting-participants-count" }, index$1.h("span", null, this.badgeCount <= 100 ? this.badgeCount : '99+'))), index$1.h("rtk-controlbar-button", { ref: (el) => (this.buttonEl = el), part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: { active: this.participantsActive }, onClick: () => this.toggleParticipantsTab(), icon: this.iconPack.participants, label: text, variant: this.variant })));
    }
...
exports.rtk_participants_toggle = RtkParticipantsToggle;
