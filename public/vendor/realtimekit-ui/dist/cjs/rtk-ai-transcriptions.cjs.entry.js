...
const RtkAiTranscriptions = class {
    ...
    meetingChanged(meeting) {
        var _a, _b;
        this.transcriptions = uiStore.clone((_a = meeting === null || meeting === void 0 ? void 0 : meeting.ai) === null || _a === void 0 ? void 0 : _a.transcripts);
    ...
    renderTranscripts() {
        ...
        return renderedTranscripts.map((transcription) => {
            return (index$1.h("div", { class: "message" }, index$1.h(ChatHead.ChatHead, { name: transcription.name, time: new Date(transcription.date), now: new Date() }), index$1.h("div", { class: "body" }, transcription.transcript)));
        });
    }
    render() {
        return (index$1.h(index$1.Host, { key: 'f9d8cea8917ddb558fd721020c71e32964c4e653' }, index$1.h("div", { key: 'b35cf0970ccf2b813c99976e1554c2a4dc60ac12', class: "search-bar" }, index$1.h("input", { key: 'd6c84982fbf1f5b7c9b8264228f622ca74d60672', type: "text", placeholder: "Search Participant", value: this.participantQuery, onInput: (e) => (this.participantQuery = e.target.value) })), this.isProcessing && (index$1.h("div", { key: 'fbd031e9acdd967e2e81bcb655d3ff80a33210f5', class: "processing" }, index$1.h("p", { key: '7ee274172423aaac3f286f9463ae2c2b0a01d09e' }, "Processing audio...."))), !this.isProcessing && (index$1.h("div", { key: 'e07f3a7314132300113f955e7a83bc2ca18e6bc5', class: "content scrollbar", ref: (el) => (this.contentContainer = el) }, index$1.h("div", { key: '3ffd0b4a02a6aaa136a282f145772e2f3afd3bc1', class: "started-message" }, "Transcription started"), this.renderTranscripts()))));
    }
...
exports.rtk_ai_transcriptions = RtkAiTranscriptions;
