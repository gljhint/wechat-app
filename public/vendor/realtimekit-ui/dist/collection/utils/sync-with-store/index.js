...
import { uiStore as legacyGlobalUIStore, appendElement, removeElement, } from "./ui-store";
    ...
    return function (proto, propName) {
        ...
        proto.connectedCallback = function () {
            ...
            if (!value) {
                ...
                appendElement(propName, host, legacyGlobalUIStore);
            }
            ...
            const storeResponseListener = (event) => {
                ...
                if (event.detail.requestId === requestId) {
                    ...
                    removeElement(propName, host, legacyGlobalUIStore);
                }
            };
