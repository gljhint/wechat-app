...
import { getBitrateVerdict, getJitterVerdict, getNetworkBasedMediaHealth, getPacketLossVerdict, } from "../../utils/debugger-utils";
export class RtkDebuggerScreenShare {
    ...
    static get is() { return "rtk-debugger-screenshare"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() {
        return {
            "$": ["rtk-debugger-screenshare.css"]
        };
    }
    ...
    static get states() {
        return {
            ...
            "audioProducerFormattedStats": {},
            "audioProducerScoreStats": {},
            "networkBasedMediaHealth": {}
        };
    }
    static get watchers() {
        return [{
                "propName": "videoProducerScoreStats",
                "methodName": "videoProducerScoreStatsChanged"
            }, {
                "propName": "audioProducerScoreStats",
                "methodName": "audioProducerScoreStatsChanged"
            }, {
                "propName": "meeting",
