...
import { getBatteryChargingVerdict, getBatteryLevelVerdict, getOverallBatteryVerdict, } from "../../utils/debugger-utils";
export class RtkDebuggerSystem {
    ...
    static get is() { return "rtk-debugger-system"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() {
        return {
            "$": ["rtk-debugger-system.css"]
        };
    }
    ...
    static get states() {
        return {
            "isBatterySectionOpen": {},
            "batterySectionHealth": {},
            "battery": {},
            "batteryFormattedStats": {}
        };
    }
    static get watchers() {
        return [{
