...
export class RtkChatMessage {
    ...
    static get is() { return "rtk-chat-message"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() {
        return {
            "$": ["rtk-chat-message.css"]
        };
    }
    ...
    static get properties() {
        return {
            ...
            "canReply": {
                ...
                "docs": {
                    "tags": [],
                    "text": "can quote reply this message"
                },
                "getter": false,
                "setter": false,
                "attribute": "can-reply",
            ...
            "senderDisplayPicture": {
                ...
                "docs": {
                    "tags": [],
                    "text": "sender display picture url"
                },
                "getter": false,
                "setter": false,
                "attribute": "sender-display-picture",
                "reflect": false
            },
            "hideAvatar": {
                "type": "boolean",
            ...
            "leftAlign": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Whether to left align the chat bubbles"
                },
                "getter": false,
                "setter": false,
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [],
                    "text": "Event for when edit is clicked on a message"
                },
                "complexType": {
                    "original": "Message",
                    "resolved": "CustomMessage | FileMessage | ImageMessage | TextMessage",
                ...
                "docs": {
                    "tags": [],
                    "text": "Event for when reply is clicked on a message"
                },
                "complexType": {
                    "original": "Message",
                    "resolved": "CustomMessage | FileMessage | ImageMessage | TextMessage",
                ...
                "docs": {
                    "tags": [],
                    "text": "Event for when pin is clicked on a message"
                },
                "complexType": {
                    "original": "Message",
                    "resolved": "CustomMessage | FileMessage | ImageMessage | TextMessage",
