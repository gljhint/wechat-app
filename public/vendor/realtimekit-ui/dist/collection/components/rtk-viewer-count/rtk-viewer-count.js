...
export class RtkViewerCount {
    ...
    static get is() { return "rtk-viewer-count"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() {
        return {
            "$": ["rtk-viewer-count.css"]
        };
    }
            ...
            "variant": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "ViewerCountVariant": {
                            "location": "local",
                            "path": "/home/runner/work/realtimekit-ui/realtimekit-ui/packages/core/src/components/rtk-viewer-count/rtk-viewer-count.tsx",
                            "id": "src/components/rtk-viewer-count/rtk-viewer-count.tsx::ViewerCountVariant"
                        }
                    }
                },
                "required": false,
