...
import { defaultIconPack, createDefaultConfig, } from "../../exports";
...
export class RtkParticipantsViewers {
    ...
    static get is() { return "rtk-participants-viewer-list"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() {
        return {
            "$": ["rtk-participants-viewer-list.css"]
        };
    }
                ...
                "complexType": {
                    ...
                    "references": {
                        "ParticipantsViewMode": {
                            "location": "import",
                            "path": "../rtk-participants/rtk-participants",
                            "id": "src/components/rtk-participants/rtk-participants.tsx::ParticipantsViewMode"
                        }
                    }
                },
                "required": false,
