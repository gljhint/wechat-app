...
import { g as generateChatGroupKey } from './p-0abe4b8a.js';
...
const RtkChatSelectorUi$1 = /*@__PURE__*/ proxyCustomElement(class RtkChatSelectorUi extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return RtkChatSelectorUiStyle0; }
}, [1, "rtk-chat-selector-ui", {
...
__decorate([
    SyncWithStore()
], RtkChatSelectorUi$1.prototype, "iconPack", void 0);
__decorate([
    SyncWithStore()
], RtkChatSelectorUi$1.prototype, "t", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["rtk-chat-selector-ui", "rtk-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-chat-selector-ui":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkChatSelectorUi$1);
            }
            break;
        case "rtk-icon":
            if (!customElements.get(tagName)) {
...
const RtkChatSelectorUi = RtkChatSelectorUi$1;
const defineCustomElement = defineCustomElement$1;

export { RtkChatSelectorUi, defineCustomElement };
