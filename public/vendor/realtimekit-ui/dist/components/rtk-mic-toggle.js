...
const RtkMicToggle$1 = /*@__PURE__*/ proxyCustomElement(class RtkMicToggle extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return RtkMicToggleStyle0; }
}, [1, "rtk-mic-toggle", {
        "variant": [513],
        "meeting": [16],
        "size": [513],
...
__decorate([
    SyncWithStore()
], RtkMicToggle$1.prototype, "meeting", void 0);
__decorate([
    SyncWithStore()
], RtkMicToggle$1.prototype, "iconPack", void 0);
__decorate([
    SyncWithStore()
], RtkMicToggle$1.prototype, "t", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["rtk-mic-toggle", "rtk-controlbar-button", "rtk-icon", "rtk-spinner", "rtk-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-mic-toggle":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkMicToggle$1);
            }
            break;
...
const RtkMicToggle = RtkMicToggle$1;
const defineCustomElement = defineCustomElement$1;

export { RtkMicToggle, defineCustomElement };
