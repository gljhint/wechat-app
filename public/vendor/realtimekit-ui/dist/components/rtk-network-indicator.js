...
const RtkNetworkIndicator$1 = /*@__PURE__*/ proxyCustomElement(class RtkNetworkIndicator extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return RtkNetworkIndicatorStyle0; }
}, [1, "rtk-network-indicator", {
        "participant": [16],
        "meeting": [16],
        "iconPack": [16],
        "t": [16],
...
__decorate([
    SyncWithStore()
], RtkNetworkIndicator$1.prototype, "meeting", void 0);
__decorate([
    SyncWithStore()
], RtkNetworkIndicator$1.prototype, "iconPack", void 0);
__decorate([
    SyncWithStore()
], RtkNetworkIndicator$1.prototype, "t", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["rtk-network-indicator", "rtk-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-network-indicator":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkNetworkIndicator$1);
            }
            break;
        case "rtk-icon":
            if (!customElements.get(tagName)) {
...
const RtkNetworkIndicator = RtkNetworkIndicator$1;
const defineCustomElement = defineCustomElement$1;

export { RtkNetworkIndicator, defineCustomElement };
