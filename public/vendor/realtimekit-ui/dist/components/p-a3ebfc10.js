...
const RtkVirtualizedParticipantList = /*@__PURE__*/ proxyCustomElement(class RtkVirtualizedParticipantList extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return RtkVirtualizedParticipantListStyle0; }
}, [0, "rtk-virtualized-participant-list", {
        "items": [16],
        "renderItem": [16],
...
function defineCustomElement() {
    ...
    const components = ["rtk-virtualized-participant-list"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-virtualized-participant-list":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkVirtualizedParticipantList);
            }
            break;
    } });
}
...
export { RtkVirtualizedParticipantList as R, defineCustomElement as d };
