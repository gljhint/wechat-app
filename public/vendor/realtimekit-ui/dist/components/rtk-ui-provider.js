...
import { e as defaultIconPack, h as useLanguage, c as createDefaultConfig, u as uiStore, b as createPeerStore } from './p-74e01969.js';
import { d as deepMerge, p as provideRtkDesignSystem } from './p-d4ada89c.js';
...
const RtkUiProvider$1 = /*@__PURE__*/ proxyCustomElement(class RtkUiProvider extends H {
    constructor() {
        super();
        this.__registerHost();
...
function defineCustomElement$1() {
    ...
    const components = ["rtk-ui-provider"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-ui-provider":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkUiProvider$1);
            }
            break;
    } });
}
...
const RtkUiProvider = RtkUiProvider$1;
const defineCustomElement = defineCustomElement$1;

export { RtkUiProvider, defineCustomElement };
