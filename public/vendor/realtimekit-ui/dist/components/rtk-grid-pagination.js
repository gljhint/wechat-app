...
const RtkGridPagination$1 = /*@__PURE__*/ proxyCustomElement(class RtkGridPagination extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return RtkGridPaginationStyle0; }
}, [1, "rtk-grid-pagination", {
        "meeting": [16],
        "states": [16],
        "size": [513],
        "variant": [513],
...
__decorate([
    SyncWithStore()
], RtkGridPagination$1.prototype, "meeting", void 0);
__decorate([
    SyncWithStore()
], RtkGridPagination$1.prototype, "states", void 0);
__decorate([
    SyncWithStore()
], RtkGridPagination$1.prototype, "iconPack", void 0);
__decorate([
    SyncWithStore()
], RtkGridPagination$1.prototype, "t", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["rtk-grid-pagination", "rtk-button", "rtk-icon", "rtk-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-grid-pagination":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkGridPagination$1);
            }
            break;
        case "rtk-button":
            if (!customElements.get(tagName)) {
...
const RtkGridPagination = RtkGridPagination$1;
const defineCustomElement = defineCustomElement$1;

export { RtkGridPagination, defineCustomElement };
