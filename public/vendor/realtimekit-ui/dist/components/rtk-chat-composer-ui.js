...
import { d as defineCustomElement$5 } from './p-c8b8a942.js';
...
const MENTION_CHAR = '@';
const RtkChatComposerUi$1 = /*@__PURE__*/ proxyCustomElement(class RtkChatComposerUi extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return RtkChatComposerUiStyle0; }
}, [1, "rtk-chat-composer-ui", {
...
__decorate([
    SyncWithStore()
], RtkChatComposerUi$1.prototype, "iconPack", void 0);
__decorate([
    SyncWithStore()
], RtkChatComposerUi$1.prototype, "t", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["rtk-chat-composer-ui", "rtk-avatar", "rtk-button", "rtk-emoji-picker", "rtk-icon", "rtk-spinner", "rtk-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-chat-composer-ui":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkChatComposerUi$1);
            }
            break;
        case "rtk-avatar":
            if (!customElements.get(tagName)) {
...
const RtkChatComposerUi = RtkChatComposerUi$1;
const defineCustomElement = defineCustomElement$1;

export { RtkChatComposerUi, defineCustomElement };
