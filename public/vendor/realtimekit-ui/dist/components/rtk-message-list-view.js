import { p as proxyCustomElement, H, w as writeTask, h } from './p-c3592601.js';
...
const RtkMessageListView$1 = /*@__PURE__*/ proxyCustomElement(class RtkMessageListView extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return RtkMessageListViewStyle0; }
}, [0, "rtk-message-list-view", {
        "messages": [16],
        "renderer": [16],
        "loadMore": [16],
...
__decorate([
    SyncWithStore()
], RtkMessageListView$1.prototype, "iconPack", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["rtk-message-list-view", "rtk-icon", "rtk-spinner"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-message-list-view":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkMessageListView$1);
            }
            break;
        case "rtk-icon":
            if (!customElements.get(tagName)) {
...
const RtkMessageListView = RtkMessageListView$1;
const defineCustomElement = defineCustomElement$1;

export { RtkMessageListView, defineCustomElement };
