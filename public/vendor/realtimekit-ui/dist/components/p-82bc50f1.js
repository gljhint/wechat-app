...
const RtkSidebarUi = /*@__PURE__*/ proxyCustomElement(class RtkSidebarUi extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        ...
        this.onClose = () => {
             ...
             */
            if (document.activeElement instanceof H &&
    ...
    static get style() { return RtkSidebarUiStyle0; }
}, [1, "rtk-sidebar-ui", {
        "view": [513],
        "tabs": [16],
        "hideHeader": [4, "hide-header"],
        "hideCloseAction": [4, "hide-close-action"],
        "currentTab": [1, "current-tab"],
        "iconPack": [16],
        "focusCloseButton": [4, "focus-close-button"],
        "t": [16]
    }, undefined, {
        "currentTab": ["handleFocusCloseButton"]
    }]);
...
function defineCustomElement() {
    ...
    const components = ["rtk-sidebar-ui", "rtk-button", "rtk-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-sidebar-ui":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkSidebarUi);
            }
            break;
        case "rtk-button":
            if (!customElements.get(tagName)) {
...
export { RtkSidebarUi as R, defineCustomElement as d };
