...
const RtkStageToggle$1 = /*@__PURE__*/ proxyCustomElement(class RtkStageToggle extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return RtkStageToggleStyle0; }
}, [1, "rtk-stage-toggle", {
        "variant": [513],
        "meeting": [16],
        "size": [513],
...
__decorate([
    SyncWithStore()
], RtkStageToggle$1.prototype, "meeting", void 0);
__decorate([
    SyncWithStore()
], RtkStageToggle$1.prototype, "iconPack", void 0);
__decorate([
    SyncWithStore()
], RtkStageToggle$1.prototype, "states", void 0);
__decorate([
    SyncWithStore()
], RtkStageToggle$1.prototype, "t", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["rtk-stage-toggle", "rtk-controlbar-button", "rtk-icon", "rtk-spinner", "rtk-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-stage-toggle":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkStageToggle$1);
            }
            break;
...
const RtkStageToggle = RtkStageToggle$1;
const defineCustomElement = defineCustomElement$1;

export { RtkStageToggle, defineCustomElement };
