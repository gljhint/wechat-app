...
const RtkDebuggerVideo = /*@__PURE__*/ proxyCustomElement(class RtkDebuggerVideo extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return RtkDebuggerVideoStyle0; }
}, [1, "rtk-debugger-video", {
        "meeting": [16],
        "states": [16],
        "size": [513],
        "iconPack": [16],
...
function defineCustomElement() {
    ...
    const components = ["rtk-debugger-video"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-debugger-video":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkDebuggerVideo);
            }
            break;
    } });
}
...
export { RtkDebuggerVideo as R, defineCustomElement as d };
