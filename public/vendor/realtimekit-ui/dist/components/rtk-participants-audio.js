...
import { C as disableSettingSinkId, e as defaultIconPack, h as useLanguage, N as isLiveStreamViewer } from './p-74e01969.js';
import { S as SyncWithStore } from './p-beb5c7c8.js';
import { d as defineCustomElement$4 } from './p-1391bef0.js';
import { d as defineCustomElement$3 } from './p-dc9eb0c2.js';
...
const RtkParticipantsAudio$1 = /*@__PURE__*/ proxyCustomElement(class RtkParticipantsAudio extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return RtkParticipantsAudioStyle0; }
}, [1, "rtk-participants-audio", {
        "meeting": [16],
        "iconPack": [16],
        "t": [16],
...
__decorate([
    SyncWithStore()
], RtkParticipantsAudio$1.prototype, "meeting", void 0);
__decorate([
    SyncWithStore()
], RtkParticipantsAudio$1.prototype, "iconPack", void 0);
__decorate([
    SyncWithStore()
], RtkParticipantsAudio$1.prototype, "t", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["rtk-participants-audio", "rtk-button", "rtk-dialog", "rtk-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "rtk-participants-audio":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RtkParticipantsAudio$1);
            }
            break;
        case "rtk-button":
            if (!customElements.get(tagName)) {
...
const RtkParticipantsAudio = RtkParticipantsAudio$1;
const defineCustomElement = defineCustomElement$1;

export { RtkParticipantsAudio, defineCustomElement };
